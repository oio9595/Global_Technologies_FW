...
typedef union _xc24_global_fault
{
    ...
    struct
    {
        _v_global_fault_read_data1_t _rD1;
        _v_global_fault_read_data2_t _rD2;
        _v_global_fault_read_data3_t _rD3;
        _v_global_fault_read_data4_t _rD4;
        _v_global_fault_read_data5_t _rD5;
        _v_global_fault_read_data6_t _rD6;
    };
}_xc24_global_fault_t;

typedef union _xc24_local_rw_data
{
    uint16_t ALL[16];
    struct
    {
        _v_port_local_rw_data_t _r70;
        _v_port_local_rw_data_t _r78;
        _v_port_local_rw_data_t _r80;
        _v_port_local_rw_data_t _r88;
        _v_port_local_rw_data_t _r90;
        _v_port_local_rw_data_t _r98;
        _v_port_local_rw_data_t _rA0;
        _v_port_local_rw_data_t _rA8;
        _v_port_local_rw_data_t _rB0;
        _v_port_local_rw_data_t _rB8;
        _v_port_local_rw_data_t _rC0;
        _v_port_local_rw_data_t _rC8;
        _v_port_local_rw_data_t _rD0;
        _v_port_local_rw_data_t _rD8;
        _v_port_local_rw_data_t _rE0;
        _v_port_local_rw_data_t _rE8;
    };
}_xc24_local_rw_data_t;
...
EXTERN void XC24_IF_Write_LD(uint16_t* p_ld_buff);
EXTERN void XC24_IF_Local_Read(uint16_t in_xd_reg_addr);
EXTERN uint16_t* XC24_IF_Get_Local_RW_Data_Pointer(void);
