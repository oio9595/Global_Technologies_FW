...
static _reg_map_t gt_xdic_mirror_maps[] =
{
    ...
    XDIC_MIRROR_REG_ENTRY( XDIC_MIRROR_ADDR_ICTL_L_CH_05, _r07 ),
    XDIC_MIRROR_REG_ENTRY( XDIC_MIRROR_ADDR_ICTL_L_CH_06, _r08 ),
    XDIC_MIRROR_REG_ENTRY( XDIC_MIRROR_ADDR_ICTL_L_CH_07, _r09 ),
    XDIC_MIRROR_REG_ENTRY( XDIC_MIRROR_ADDR_ICTL_L_CH_08, _r0A ),
    XDIC_MIRROR_REG_ENTRY( XDIC_MIRROR_ADDR_ICTL_L_CH_09, _r0B ),
    XDIC_MIRROR_REG_ENTRY( XDIC_MIRROR_ADDR_ICTL_L_CH_10, _r0C ),
    XDIC_MIRROR_REG_ENTRY( XDIC_MIRROR_ADDR_ICTL_L_CH_11, _r0D ),
    XDIC_MIRROR_REG_ENTRY( XDIC_MIRROR_ADDR_ICTL_L_CH_12, _r0E ),
    ...
    XDIC_MIRROR_REG_ENTRY( XDIC_MIRROR_ADDR_ICTL_H_CH_05, _r1F ),
    XDIC_MIRROR_REG_ENTRY( XDIC_MIRROR_ADDR_ICTL_H_CH_06, _r20 ),
    XDIC_MIRROR_REG_ENTRY( XDIC_MIRROR_ADDR_ICTL_H_CH_07, _r21 ),
    XDIC_MIRROR_REG_ENTRY( XDIC_MIRROR_ADDR_ICTL_H_CH_08, _r22 ),
    XDIC_MIRROR_REG_ENTRY( XDIC_MIRROR_ADDR_ICTL_H_CH_09, _r23 ),
    XDIC_MIRROR_REG_ENTRY( XDIC_MIRROR_ADDR_ICTL_H_CH_10, _r24 ),
    XDIC_MIRROR_REG_ENTRY( XDIC_MIRROR_ADDR_ICTL_H_CH_11, _r25 ),
    XDIC_MIRROR_REG_ENTRY( XDIC_MIRROR_ADDR_ICTL_H_CH_12, _r26 ),
};
