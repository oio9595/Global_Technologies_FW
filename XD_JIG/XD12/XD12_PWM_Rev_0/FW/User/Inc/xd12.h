...
EXTERN void XD12_set_dimming_channel(uint8_t n_channel);
EXTERN uint8_t XD12_get_dimming_channel(void);
...
EXTERN uint8_t TargetIC_IF_TrimRegister_Set(uint8_t ch_num, trim_mode_t in_trim_mode, uint16_t in_reg_val);
...
EXTERN void TargetIC_IF_TRIM_Init_ICTL_L(void);
EXTERN void TargetIC_IF_TRIM_Init_ICTL_H(void);
...
EXTERN void XD12_detect_FBO(void);

EXTERN void XD12_Initialize(void);
EXTERN void XD12_Trim_Initialize(void);

EXTERN void XD12_Debug_Initialize(void);
