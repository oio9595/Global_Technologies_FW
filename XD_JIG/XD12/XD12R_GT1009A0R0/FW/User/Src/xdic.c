...
#define XDIC_LD_TYPE_2              (1) // R/GB, 6CH
#define XDIC_LD_TYPE_3              (1) // MONO, 12CH
...
#define XDIC_R01_DAC_A_OFS_SHIFT    (0)
#define XDIC_R01_DAC_A_OFS_MASK     (0x7F << XDIC_R01_DAC_A_OFS_SHIFT)

#define XDIC_R01_DAC_B_OFS_SHIFT    (7)
#define XDIC_R01_DAC_B_OFS_MASK     (0x1F << XDIC_R01_DAC_B_OFS_SHIFT)

#define XDIC_R02_BGR_TC_SHIFT       (0)
#define XDIC_R02_BGR_TC_MASK        (0x1F << XDIC_R02_BGR_TC_SHIFT)

#define XDIC_R02_IREF_CTL_SHIFT     (5)
#define XDIC_R02_IREF_CTL_MASK      (0x1F << XDIC_R02_IREF_CTL_SHIFT)

#define XDIC_R02_DAC_B_OFS_SHIFT    (10)
#define XDIC_R02_DAC_B_OFS_MASK     (0x03 << XDIC_R02_DAC_B_OFS_SHIFT)

#define XDIC_R03_OSC_RCTL_SHIFT     (0)
#define XDIC_R03_OSC_RCTL_MASK      (0x0F << XDIC_R03_OSC_RCTL_SHIFT)

#define XDIC_R03_LDO_DAC_CTL_SHIFT  (11)
#define XDIC_R03_LDO_DAC_CTL_MASK   (0x01 << XDIC_R03_LDO_DAC_CTL_SHIFT)

#define XDIC_R04_LDO_CTL_SHIFT      (0)
#define XDIC_R04_LDO_CTL_MASK       (0x0F << XDIC_R04_LDO_CTL_SHIFT)

#define XDIC_R04_LDO_OSC_CTL_SHIFT  (4)
#define XDIC_R04_LDO_OSC_CTL_MASK   (0x0F << XDIC_R04_LDO_OSC_CTL_SHIFT)
...
static dev_max_curr_level_t gt_xd_dev_max_curr_level[3] = { DEV_MAX_CURR_LEVEL_4mA, };
static short_level_t gt_xd_short_level[3] = { SHORT_LEVEL_3V5, };
static fb_level_t gt_xd_fb_level[3] = { FB_LEVEL_0V45, };

static uint16_t gn_xd_delay_ch[XDIC_CH_SIZE] = {0, };
...
void XDIC_Param_Init(void)
{
    ...
    gn_xd_ch_size = XDIC_CH_SIZE;

    for (uint8_t i = 0; i < 3; ++i)
    {
        gt_xd_fb_level[i] = FB_LEVEL_0V45;
        gt_xd_short_level[i] = SHORT_LEVEL_32V;
        gt_xd_dev_max_curr_level[i] = DEV_MAX_CURR_LEVEL_16mA;
    }
}
    ...
    for (xdic_addr_t xdic_addr = XDIC_ADDR_RESET_ID ; xdic_addr < XDIC_ADDR_MAX ; ++xdic_addr)
    {
        ...
        if (map)
        {
            ...
            case XDIC_ADDR_FPWM_DIVIDER_1_2 :
                ...
                gt_xdic_general_regs._r03.fpwm_div2 = ((gn_xd_fpwm_div & 0xF0) >> 0);
                break;
            case XDIC_ADDR_FPWM_DIVIDER_2_3 :
                gt_xdic_general_regs._r04.fpwm_div2 = ((gn_xd_fpwm_div & 0xF0) >> 4);
                gt_xdic_general_regs._r04.fpwm_div3 = gn_xd_fpwm_div;
                break;
            ...
            case XDIC_ADDR_FB_LEVEL :
                gt_xdic_general_regs._r07.fb1_level = gt_xd_fb_level[0];
                gt_xdic_general_regs._r07.fb2_level = gt_xd_fb_level[1];
                gt_xdic_general_regs._r07.fb3_level = gt_xd_fb_level[2];
                break;
            case XDIC_ADDR_SHORT_LEVEL :
                gt_xdic_general_regs._r08.short1_level = gt_xd_short_level[0];
                gt_xdic_general_regs._r08.short2_level = gt_xd_short_level[1];
                gt_xdic_general_regs._r08.short3_level = gt_xd_short_level[2];
                break;
            case XDIC_ADDR_MAX_CURRENT_LEVEL :
                gt_xdic_general_regs._r0A.max_curr_level1 = gt_xd_dev_max_curr_level[0];
                gt_xdic_general_regs._r0A.max_curr_level2 = gt_xd_dev_max_curr_level[1];
                gt_xdic_general_regs._r0A.max_curr_level3 = gt_xd_dev_max_curr_level[2];
                break;
            ...
            case XDIC_ADDR_FLL_CONTROL_1 :
                gt_xdic_general_regs._r1A.fllcnt = ((gn_xd_mclk_lock_cnt & XDIC_MCLK_LSB_MASK) >>  0);
                break;
    ...
    for (xdic_addr_t xdic_addr = XDIC_ADDR_RESET_ID ; xdic_addr < XDIC_ADDR_MAX ; ++xdic_addr)
    {
        ...
        if (map)
        {
            ...
            case XDIC_ADDR_MAX_CURRENT_LEVEL :
                ...
                break;
            case XDIC_ADDR_MAX_CURRENT_VREF1 :
                gt_xdic_general_regs._r0B.max_curr_vref = 0;
                break;
            case XDIC_ADDR_MAX_CURRENT_VREF2 :
                gt_xdic_general_regs._r0C.max_curr_vref = 0;
                break;
            case XDIC_ADDR_MAX_CURRENT_VREF3 :
                gt_xdic_general_regs._r0D.max_curr_vref = 0;
                break;
            case XDIC_ADDR_SERIAL_BAUDRATE :
                gt_xdic_general_regs._r14.serial_clk_high = XD_SERIAL_CLK_CNT_HIGH;
                gt_xdic_general_regs._r14.serial_clk_low = XD_SERIAL_CLK_CNT_LOW;
...
static void XDIC_Set_Delay_CH(void)
{
    ...
    {
        uint16_t temp_delay = ((gn_xd_delay_ch[ch * 2 + 1] << 5) | (gn_xd_delay_ch[ch * 2] << 0));
...
{
    print(LOG_INFO, "DAC_OFS,%3u\r\n", gt_xdic_mirror_regs._r01.val);
    print(LOG_INFO, "IREF_CTL_BGR_TC,%3u\r\n", gt_xdic_mirror_regs._r02.val);
    print(LOG_INFO, "LDO_DAC_CTL_OSC_RCTL,%3u\r\n", gt_xdic_mirror_regs._r03.val);
    print(LOG_INFO, "LDO_CTL,%3u\r\n", gt_xdic_mirror_regs._r04.val);
...
uint64_t XDIC_Compare_Mirror_Regs(void)
{
    ...
    for (xdic_mirror_addr_t mirror_addr = XDIC_MIRROR_ADDR_OTP_CRC ; mirror_addr < XDIC_MIRROR_ADDR_MAX ; ++mirror_addr)
    {
...
void XDIC_Trim_Partial_CH_GAIN(void)
{
    ...
    for (uint8_t i = 0 ; i < XDIC_CH_SIZE ; ++i)
    {
        ...
        XDIC_Set_Max_Curr_Vref(1500); // XDIC_GAIN_P1
        ADS114S08_Set_Start(1);
        ADS114S08_Wait_Done();
        iout_adc[i][0] = ADS114S08_Get_ADC_Value();

        XDIC_Set_Max_Curr_Vref(300); // XDIC_GAIN_P2
        ADS114S08_Set_Start(1);
        ADS114S08_Wait_Done();
...
void XDIC_Trim_Partial_CH_OFS(void)
{
    ...
    for (uint8_t i = 0 ; i < XDIC_CH_SIZE ; ++i)
    {
        ...
        XDIC_Set_Max_Curr_Vref(200); // XDIC_OFS_P1
        ADS114S08_Set_Start(1);
        ADS114S08_Wait_Done();
        iout_adc[i][0] = ADS114S08_Get_ADC_Value();

        XDIC_Set_Max_Curr_Vref(400); // XDIC_OFS_P2
        ADS114S08_Set_Start(1);
        ADS114S08_Wait_Done();
        iout_adc[i][1] = ADS114S08_Get_ADC_Value();
