...
volatile bool gb_xd_max_curr_lvl_set;
uint8_t gn_xd_max_curr_lvl;

volatile bool gb_xd_vrev_set;
uint16_t gn_xd_vref;
...
void key_func_1(void)
{
    ...
    XDIC_Set_LD_Data(16383);
    print(LOG_INFO, "TEST 1 : Current Deviation (1mA)\r\n");
}

void key_func_2(void)
{
    gb_xd_max_curr_lvl_set = true;
    gn_xd_max_curr_lvl = DEV_MAX_CURR_LEVEL_8mA;

    //gb_xd_vrev_set = true;
    //gn_xd_vref = 4095;

    XDIC_Set_LD_Data(8192);
    print(LOG_INFO, "TEST 2 : Current Jitter (1.5us)\r\n");
    print(LOG_INFO, "\tMax Current 8mA\r\n");
    print(LOG_INFO, "\tVref 4095\r\n");
    print(LOG_INFO, "\tLDim 8192\r\n");
}

void key_func_3(void)
{
    gb_xd_max_curr_lvl_set = true;
    gn_xd_max_curr_lvl = DEV_MAX_CURR_LEVEL_4mA;

    gb_xd_vrev_set = true;
    gn_xd_vref = 4095;

    XDIC_Set_LD_Data(16383);
    print(LOG_INFO, "TEST 3 : Icc @ Max Current 4mA\r\n");
    print(LOG_INFO, "\tMax Current 4mA\r\n");
    print(LOG_INFO, "\tVref 4095\r\n");
    print(LOG_INFO, "\tLDim 16383\r\n");
}

void key_func_4(void)
{
    gb_xd_max_curr_lvl_set = true;
    gn_xd_max_curr_lvl = DEV_MAX_CURR_LEVEL_32mA;

    gb_xd_vrev_set = true;
    gn_xd_vref = 511;

    XDIC_Set_LD_Data(16383);
    print(LOG_INFO, "TEST 3 : Icc @ Max Current 32mA\r\n");
    print(LOG_INFO, "\tMax Current 32mA\r\n");
    print(LOG_INFO, "\tVref 511\r\n");
    print(LOG_INFO, "\tLDim 16383\r\n");
}
...
static key_info_t gt_key_info = {
    ...
    .press_cnt = 0,
    .function_ptr = 0,
    .function = { key_func_1, key_func_2, key_func_3, key_func_4 },
};
    ...
    if (gn_key_task_tick == 0)
    {
        ...
        if (gt_key_info.now_state != gt_key_info.prev_state)
        {
            ...
            else
            {
                ...
                {
                    if (gt_key_info.function[gt_key_info.function_ptr] != NULL)
                    {
                        gt_key_info.function[gt_key_info.function_ptr]();
                    }
                    ++gt_key_info.function_ptr;
                    if (gt_key_info.function_ptr > 4)
                    {
                        gt_key_info.function_ptr = 0;
                    }
                }
