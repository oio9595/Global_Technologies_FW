...
void XDIC_Trim_Partial_DAC_LDO_1V5(void)
{
    ...
    {
        XDIC_Write_Substitute_Value_By_Trim_Mode(0, XD_TRIM_DAC_LDO_1V5, reg);
        JigBD_IF_Start_MCU_ADC();
        uint16_t mcu_adc =  JigBD_IF_Get_MCU_ADC();
        print(LOG_INFO, "\r\n reg, %u, DAC_LDO_1V5, %.3f\r\n", reg, JigBD_IF_Convert_MCU_ADC_To_Volt(mcu_adc));
    }
}
...
void XDIC_Trim_Partial_DIG_LDO_1V5(void)
{
    ...
    {
        XDIC_Write_Substitute_Value_By_Trim_Mode(0, XD_TRIM_DIG_LDO_1V5, i);
        JigBD_IF_Start_MCU_ADC();
        uint16_t mcu_adc =  JigBD_IF_Get_MCU_ADC();
        print(LOG_INFO, "\r\n reg, %u, DIG_LDO_1V5, %.3f\r\n", i, JigBD_IF_Convert_MCU_ADC_To_Volt(mcu_adc));
    }
}
