...
static bool gb_xd_freq_monitor;
static uint8_t gn_xd_freq_monitor_tick = 1;
static bool gb_xd_freq_monitor_tick_minus_enable;
...
void sys_tick_handler(void)
{
    ...
    if (gb_xd_freq_monitor_tick_minus_enable)
    {
        if (gn_xd_freq_monitor_tick)
        {
            --gn_xd_freq_monitor_tick;
            if (gn_xd_freq_monitor_tick == 0)
            {
                gb_xd_freq_monitor = true;
            }
        }
    }
}
...
int main(void)
{
  ...
  while (1)
  {
    ...
    if (gb_xd_freq_monitor)
    {
        XDIC_Trim_Partial_OSC();
        gb_xd_freq_monitor = false;
        gn_xd_freq_monitor_tick = 1;
    }
  }
  /* USER CODE END 3 */
}
...
/* ----------------- command list - xd ----------------- */
        ...
        {
            XDIC_Trim_Show_OSC();
            gb_xd_freq_monitor_tick_minus_enable = true;
            print(LOG_INFO, "\r\n OK\r\n");
        }
