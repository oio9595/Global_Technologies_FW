...
#define XDIC_OFS_ERR_RATE           (2.2f / 100)   /* % */
#define XDIC_OFS_P1                 (10)
#define XDIC_OFS_P2                 (40)
#define XDIC_OFS_CAL                (0.13f * 24.0f / 12.0f)
#define XDIC_OFS_TARGET             (1.0f * (24.0f * (XDIC_OFS_P1 + XDIC_OFS_P2) / (XDIC_VREF_MAX * 2.0f) + XDIC_OFS_CAL))   /* mA */

#define XDIC_GAIN_ERR_RATE          (0.5f / 100)   /* % */
#define XDIC_GAIN_P1                (1000)
#define XDIC_GAIN_P2                (3000)
#define XDIC_GAIN_TARGET            (1.0f * (24.0f * (XDIC_GAIN_P2 - XDIC_GAIN_P1) / (XDIC_VREF_MAX)))   /* mA */
/* ---------------------------------------------------------------------------------------------------------------------- */
