...
#define XDIC_OFS_MAX_CURRENT_LVL    (DEV_MAX_CURR_LEVEL_24mA)
#define XDIC_GAIN_MAX_CURRENT_LVL   (DEV_MAX_CURR_LEVEL_24mA)
...
{
    XD_SCREEN_STEP_NONE = 0,
    XD_SCREEN_STEP_PWR_ON,
    XD_SCREEN_STEP_SETUP,
    XD_SCREEN_STEP_SET_MAX_CURR_LVL,
