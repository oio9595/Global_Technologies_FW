...
#define XD_DAISY_SIZE               (2U)
#define XD_CH_SIZE                  (4U)
#define XC_CH_ENABLE_SIZE           (20U)
...
#define XD_SERIAL_CLK_CNT_LOW       (13U)
#define XD_SERIAL_CLK_CNT_HIGH      (26U)
