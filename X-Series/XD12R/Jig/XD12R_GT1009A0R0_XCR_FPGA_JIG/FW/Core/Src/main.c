...
void PeriphCommonClock_Config(void)
{
  ...
  */
  ...
  PeriphClkInitStruct.PLLI2S.PLLI2SN = 375;
...
static void MX_ADC1_Init(void)
{
  ...
  PB0   ------> ADC1_IN8
  */
  GPIO_InitStruct.Pin = XD_ADO_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(XD_ADO_GPIO_Port, &GPIO_InitStruct);
...
static void MX_SPI1_Init(void)
{
  ...
  PA7   ------> SPI1_MOSI
  */
  GPIO_InitStruct.Pin = FPGA_SPI_CLK_Pin|FPGA_SPI_MISO_Pin|FPGA_SPI_MOSI_Pin;
...
static void MX_TIM1_Init(void)
{
  ...
  PA8   ------> TIM1_CH1
  */
  GPIO_InitStruct.Pin = XD_SERIAL_OUT_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_DOWN;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_1;
  LL_GPIO_Init(XD_SERIAL_OUT_GPIO_Port, &GPIO_InitStruct);
...
static void MX_TIM2_Init(void)
{
  ...
  PB3   ------> TIM2_CH2
  */
  GPIO_InitStruct.Pin = XD_SERIAL_IN_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_DOWN;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_1;
  LL_GPIO_Init(XD_SERIAL_IN_GPIO_Port, &GPIO_InitStruct);
...
static void MX_TIM5_Init(void)
{
  ...
  PA0-WKUP   ------> TIM5_CH1
  */
  GPIO_InitStruct.Pin = XD_FREQ_INPUT_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_2;
  LL_GPIO_Init(XD_FREQ_INPUT_GPIO_Port, &GPIO_InitStruct);
...
static void MX_TIM8_Init(void)
{
  ...
  PC7   ------> TIM8_CH2
  */
  GPIO_InitStruct.Pin = FPGA_VSYNC_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_3;
  LL_GPIO_Init(FPGA_VSYNC_GPIO_Port, &GPIO_InitStruct);
...
static void MX_USART3_UART_Init(void)
{
  ...
  PC10   ------> USART3_TX
  */
  GPIO_InitStruct.Pin = FPGA_UART_Rx_Pin|FPGA_UART_Tx_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
...
static void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_SetOutputPin(GPIOC, LTC_HIGH_CURRENT_Pin|XD_CH_SEL1_Pin);

  /**/
  LL_GPIO_SetOutputPin(GPIOA, LTC_LOW_CURRENT_Pin|LTC_MID_CURRENT_Pin|ADC_CS_Pin|XD_CH_SEL2_Pin);

  /**/
  LL_GPIO_SetOutputPin(GPIOB, XD_CH_SEL4_Pin|XD_CH_SEL3_Pin|XD_FREQ_RESET_Pin|VLED_CTR_9V_Pin
                          |XD_VCC_EN_Pin);

  /**/
  LL_GPIO_ResetOutputPin(SERIAL_SWITCH_GPIO_Port, SERIAL_SWITCH_Pin);

  /**/
  LL_GPIO_ResetOutputPin(GPIOB, XD_5V5_Pin|FPGA_NSCS_Pin);
  ...
  /**/
  GPIO_InitStruct.Pin = LTC_HIGH_CURRENT_Pin|SERIAL_SWITCH_Pin|XD_CH_SEL1_Pin;
  ...
  /**/
  GPIO_InitStruct.Pin = LTC_LOW_CURRENT_Pin|LTC_MID_CURRENT_Pin|ADC_CS_Pin|XD_CH_SEL2_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  ...
  /**/
  GPIO_InitStruct.Pin = XD_CH_SEL4_Pin|XD_CH_SEL3_Pin|XD_5V5_Pin|VLED_CTR_9V_Pin
                          |XD_VCC_EN_Pin|FPGA_NSCS_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  ...
  /**/
  GPIO_InitStruct.Pin = LL_GPIO_PIN_2|LL_GPIO_PIN_7|LL_GPIO_PIN_8;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /**/
  GPIO_InitStruct.Pin = XD_FREQ_RESET_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(XD_FREQ_RESET_GPIO_Port, &GPIO_InitStruct);
  ...
  /**/
  LL_GPIO_SetPinPull(nINT_LD_GPIO_Port, nINT_LD_Pin, LL_GPIO_PULL_NO);

  /**/
  LL_GPIO_SetPinPull(nINT_FT_GPIO_Port, nINT_FT_Pin, LL_GPIO_PULL_NO);

  /**/
  LL_GPIO_SetPinMode(ADC_DRDY_GPIO_Port, ADC_DRDY_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(nINT_LD_GPIO_Port, nINT_LD_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(nINT_FT_GPIO_Port, nINT_FT_Pin, LL_GPIO_MODE_INPUT);
