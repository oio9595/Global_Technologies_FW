...
{
    for(uint16_t num = 0 ; num < XDR_DAISY_LENGTH ; ++num)
    {
        ...
        xdr12_make_pwm_out_stream(gt_xd_syncgen_command[num].ALL, &gn_pwm_out_xd_syncgen[(num * XDR_BIT_SYNCGEN)], XDR_BIT_SYNCGEN);
    }
