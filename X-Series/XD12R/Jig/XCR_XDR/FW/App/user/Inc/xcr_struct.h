 ...
 * Revision : XC24R Rev. 00 - R_xc_xd_es0_design_specification_v0.70_260519
 */
...
typedef union tag_FAULT_READ_COMMAND
{
    ...
    struct
    {
        uint16_t ft_mode        : 2;    /* ft_mode [1:0] */
...
typedef union tag_SYNC_GEN_COMMAND
{
    ...
    struct
    {
        uint16_t syncmode       : 2;    /* syncmode [1:0], 00 = nop, 01 = (cmd + svo), 10 = (vo + svo), 11 = (rso + cmd) for xdd */
        uint16_t                : 13;   /* reserved */
        uint16_t enable         : 1;    /* enable */
    }bit;
...
typedef union tag_LD_DIFFERENCE_POINTER
{
    ...
    struct
    {
        uint16_t ld_diff_pointer : 6;    /* ld_diff_pointer [5:0] */
        uint16_t                 : 10;   /* reserved */
    }bit;
...
/* Name : INTERRUPT_ENABLE, access : r/w, default : 0x0000, address : 0x13 */
typedef union tag_INTERRUPT_ENABLE
{
    ...
    struct
    {
        ...
        uint16_t int_fault_auto_rec_fail_en : 1;     /* int_fault_auto_rec_fail_en */
        uint16_t int_fault_rec_fail_en : 1;     /* int_fault_rec_fail_en */
        uint16_t int_timeout_err_en : 1;     /* int_timeout_err_en */
        uint16_t int_spi_pc_en  : 1;     /* int_spi_pc_en */
        uint16_t int_acc_cnt_err_en : 1;     /* int_acc_cnt_err_en */
        uint16_t int_cmd_pc_en  : 1;     /* int_cmd_pc_en */
...
typedef union tag_RECEIVE_STATUS
{
    ...
    struct
    {
        ...
        uint16_t                : 2;    /* reserved */
        uint16_t timeout_err    : 1;    /* timeout_err */
        uint16_t                : 3;    /* reserved */
...
typedef union tag_INTERRUPT_STATUS
{
    ...
    struct
    {
        uint16_t int_fault      : 1;    /* int_fault (= nINT_FAULT, OD) */
        uint16_t int_ld         : 1;    /* int_ld (= nINT_LD, OD) */
        ...
        uint16_t int_rd_rec_fail_source         : 1;     /* int_rd_rec_fail_source */
        uint16_t int_fault_auto_rec_fail_source : 1;     /* int_fault_auto_rec_fail_source */
        uint16_t int_fault_rec_fail_source      : 1;     /* int_fault_rec_fail_source */
        uint16_t int_timeout_err_source         : 1;     /* int_timeout_err_source */
        uint16_t int_parity_err_source          : 1;     /* int_parity_err_source */
        uint16_t int_acc_cnt_err_source         : 1;     /* int_acc_cnt_err_source */
        uint16_t int_ovuv_err_source            : 1;     /* int_ovuv_err_source */
    }bit;
}_v_interrupt_status_t;

/* Name : CMD_PARITY_ERR_STATUS1, access : ro, default : 0x0000, address : 0x18 */
typedef union tag_CMD_PARITY_ERR_STATUS1
{
    uint16_t ALL;
    struct
    {
        uint16_t ch1_par_err    : 1;     /* ch1_par_err */
        uint16_t ch2_par_err    : 1;     /* ch2_par_err */
        uint16_t ch3_par_err    : 1;     /* ch3_par_err */
        uint16_t ch4_par_err    : 1;     /* ch4_par_err */
        uint16_t ch5_par_err    : 1;     /* ch5_par_err */
        uint16_t ch6_par_err    : 1;     /* ch6_par_err */
        uint16_t ch7_par_err    : 1;     /* ch7_par_err */
        uint16_t ch8_par_err    : 1;     /* ch8_par_err */
        uint16_t ch9_par_err    : 1;     /* ch9_par_err */
        uint16_t ch10_par_err   : 1;     /* ch10_par_err */
        uint16_t ch11_par_err   : 1;     /* ch11_par_err */
        uint16_t ch12_par_err   : 1;     /* ch12_par_err */
        uint16_t ch13_par_err   : 1;     /* ch13_par_err */
        uint16_t ch14_par_err   : 1;     /* ch14_par_err */
        uint16_t ch15_par_err   : 1;     /* ch15_par_err */
        uint16_t ch16_par_err   : 1;     /* ch16_par_err */
    }bit;
}_v_cmd_parity_err_status1_t;

/* Name : CMD_PARITY_ERR_STATUS2, access : ro, default : 0x0000, address : 0x19 */
typedef union tag_CMD_PARITY_ERR_STATUS2
{
    uint16_t ALL;
    struct
    {
        uint16_t ch17_par_err   : 1;    /* ch17_par_err */
        uint16_t ch18_par_err   : 1;    /* ch18_par_err */
        uint16_t ch19_par_err   : 1;    /* ch19_par_err */
        uint16_t ch20_par_err   : 1;    /* ch20_par_err */
        uint16_t ch21_par_err   : 1;    /* ch21_par_err */
        uint16_t ch22_par_err   : 1;    /* ch22_par_err */
        uint16_t ch23_par_err   : 1;    /* ch23_par_err */
        uint16_t ch24_par_err   : 1;    /* ch24_par_err */
        uint16_t                : 4;    /* reserved */
        uint16_t uv15_det       : 1;    /* uv15_det */
        uint16_t ov15_det       : 1;    /* ov15_det */
        uint16_t uv50_det       : 1;    /* uv50_det */
        uint16_t ov50_det       : 1;    /* ov50_det */
    }bit;
}_v_cmd_parity_err_status2_t;

/* Name : SPI_FAULT_STATUS/CONTROL, access : r/w, default : 0x0000, address : 0x1A */
typedef union tag_SPI_FAULT_STATUS_CONTROL
{
    uint16_t ALL;
    struct
    {
        uint16_t spi_parity_err_det_en  : 1;    /* spi_parity_err_det_en '0' disable  '1' enable */
        uint16_t spi_acc_cnt_err_det_en : 1;    /* spi_acc_cnt_err_det_en '0' disable  '0' enable */
        uint16_t                        : 2;    /* reserved */
        uint16_t parity_err_status      : 1;    /* parity_err_status */
        uint16_t acc_cnt_err_status     : 1;    /* acc_cnt_err_status */
        uint16_t checksum_status        : 2;    /* checksum_status [1:0] */
        uint16_t acc_counter            : 8;    /* acc_counter [7:0] */
    }bit;
}_v_spi_fault_status_control_t;

/* Name : CLK_CONTROL_1, access : r/w, default : 0x0000, address : 0x1B */
...
/* Name : CLK_CONTROL_2, access : r/w, default : 0x0000, address : 0x1C */
...
/* Name : SERIALIZER_CLOCK_GEN, access : r/w, default : 0x0C18, address : 0x1D */
typedef union tag_SERIALIZER_CLOCK_GEN
{
    uint16_t ALL;
    struct
    {
        uint16_t serial_clk_high : 7;    /* serial_clk_high [6:0] (default 24ea) */
        uint16_t                : 1;    /* reserved */
...
/* Name : LATENCY, access : r/w, default : 0x70C0, address : 0x1E */
typedef union tag_LATENCY
{
    uint16_t ALL;
    struct
    {
        uint16_t cmd_latency    : 8;     /* cmd_latency [7:0] (default 112ea) */
        uint16_t serial_latency : 8;     /* serial_latency [7:0] (default 192ea) */
    }bit;
}_v_latency_t;

/* Name : TIMEOUT, access : r/w, default : 0x7FFF, address : 0x1F */
typedef union tag_TIMEOUT
{
    uint16_t ALL;
    struct
    {
        uint16_t timeout        : 16;    /* timeout [16:1] (default 3745us) */
    }bit;
}_v_timeout_t;

/* Name : DAISIED_DEVICE_CH_SIZE, access : r/w, default : 0x0000, address : 0x20 */
typedef union tag_DAISIED_DEVICE_CH_SIZE
{
    uint16_t ALL;
    struct
    {
        uint16_t daisied_dev_blk_size   : 5;    /* daisied_dev_blk_size [4:0] */
        uint16_t                        : 11;   /* reserved */
    }bit;
}_v_daisied_device_ch_size_t;

/* Name : DAISY_SIZE_1, access : r/w, default : 0x0000, address : 0x21 */
...
/* Name : DAISY_SIZE_2, access : r/w, default : 0x0000, address : 0x22 */
...
/* Name : DAISY_SIZE_3, access : r/w, default : 0x0000, address : 0x23 */
...
/* Name : DAISY_SIZE_4, access : r/w, default : 0x0000, address : 0x24 */
...
/* Name : DAISY_SIZE_5, access : r/w, default : 0x0000, address : 0x25 */
...
/* Name : DAISY_SIZE_6, access : r/w, default : 0x0000, address : 0x26 */
...
typedef union tag_BLOCK_SIZE_1
{
    ...
    struct
    {
        uint16_t total_blk_size_ch1 : 8;     /* total_blk_size_ch1 [7:0] */
        uint16_t total_blk_size_ch2 : 8;     /* total_blk_size_ch2 [7:0] */
    }bit;
}_v_block_size_1_t;
...
typedef union tag_BLOCK_SIZE_2
{
    ...
    struct
    {
        uint16_t total_blk_size_ch3 : 8;     /* total_blk_size_ch3 [7:0] */
        uint16_t total_blk_size_ch4 : 8;     /* total_blk_size_ch4 [7:0] */
    }bit;
}_v_block_size_2_t;
...
typedef union tag_BLOCK_SIZE_3
{
    ...
    struct
    {
        uint16_t total_blk_size_ch5 : 8;     /* total_blk_size_ch5 [7:0] */
        uint16_t total_blk_size_ch6 : 8;     /* total_blk_size_ch6 [7:0] */
    }bit;
}_v_block_size_3_t;
...
typedef union tag_BLOCK_SIZE_4
{
    ...
    struct
    {
        uint16_t total_blk_size_ch7 : 8;     /* total_blk_size_ch7 [7:0] */
        uint16_t total_blk_size_ch8 : 8;     /* total_blk_size_ch8 [7:0] */
    }bit;
}_v_block_size_4_t;
...
typedef union tag_BLOCK_SIZE_5
{
    ...
    struct
    {
        uint16_t total_blk_size_ch9  : 8;     /* total_blk_size_ch9 [7:0] */
        uint16_t total_blk_size_ch10 : 8;     /* total_blk_size_ch10 [7:0] */
    }bit;
}_v_block_size_5_t;
...
typedef union tag_BLOCK_SIZE_6
{
    ...
    struct
    {
        uint16_t total_blk_size_ch11 : 8;     /* total_blk_size_ch11 [7:0] */
        uint16_t total_blk_size_ch12 : 8;     /* total_blk_size_ch12 [7:0] */
    }bit;
}_v_block_size_6_t;
...
typedef union tag_BLOCK_SIZE_7
{
    ...
    struct
    {
        uint16_t total_blk_size_ch13 : 8;     /* total_blk_size_ch13 [7:0] */
        uint16_t total_blk_size_ch14 : 8;     /* total_blk_size_ch14 [7:0] */
    }bit;
}_v_block_size_7_t;
...
typedef union tag_BLOCK_SIZE_8
{
    ...
    struct
    {
        uint16_t total_blk_size_ch15 : 8;     /* total_blk_size_ch15 [7:0] */
        uint16_t total_blk_size_ch16 : 8;     /* total_blk_size_ch16 [7:0] */
    }bit;
}_v_block_size_8_t;
...
typedef union tag_BLOCK_SIZE_9
{
    ...
    struct
    {
        uint16_t total_blk_size_ch17 : 8;     /* total_blk_size_ch17 [7:0] */
        uint16_t total_blk_size_ch18 : 8;     /* total_blk_size_ch18 [7:0] */
    }bit;
}_v_block_size_9_t;
...
typedef union tag_BLOCK_SIZE_10
{
    ...
    struct
    {
        uint16_t total_blk_size_ch19 : 8;     /* total_blk_size_ch19 [7:0] */
        uint16_t total_blk_size_ch20 : 8;     /* total_blk_size_ch20 [7:0] */
    }bit;
}_v_block_size_10_t;
...
typedef union tag_BLOCK_SIZE_11
{
    ...
    struct
    {
        uint16_t total_blk_size_ch21 : 8;     /* total_blk_size_ch21 [7:0] */
        uint16_t total_blk_size_ch22 : 8;     /* total_blk_size_ch22 [7:0] */
    }bit;
}_v_block_size_11_t;
...
typedef union tag_BLOCK_SIZE_12
{
    ...
    struct
    {
        uint16_t total_blk_size_ch23 : 8;     /* total_blk_size_ch23 [7:0] */
        uint16_t total_blk_size_ch24 : 8;     /* total_blk_size_ch24 [7:0] */
    }bit;
}_v_block_size_12_t;
...
typedef union tag_CHANNEL_ENABLE_2
{
    ...
    struct
    {
        ...
        uint16_t ch_size        : 5;     /* ch_size [4:0] */
        uint16_t                : 1;     /* reserved */
...
typedef union tag_FLLCNT12
{
    ...
    struct
    {
        ...
        uint16_t fllsync        : 1;     /* fllsync '0'  vsync '1'  ext fllsync */
        uint16_t fll1_en        : 1;     /* fll1_en '0'  disable '1'  enable */
    }bit;
}_v_fllcnt12_t;
...
typedef union tag_FLLCNT22
{
    ...
    struct
    {
        ...
        uint16_t fllsync        : 1;     /* fllsync '0'  vsync '1'  ext fllsync */
        uint16_t fll2_en        : 1;     /* fll2_en '0'  disable '1'  enable */
    }bit;
}_v_fllcnt22_t;
...
typedef union tag_VO_OFF_ON
{
    ...
    struct
    {
        uint16_t vo_on          : 8;     /* vo_on [7:0] ; max 7.28us */
        uint16_t vo_off         : 8;     /* vo_off [7:0] ; max 7.28us */
    }bit;
}_v_vo_off_on_t;
...
typedef union tag_SVO_ON
{
    ...
    struct
    {
        uint16_t svo_on         : 12;  /* svo_on [11:0] : max 117us */
        uint16_t                : 4;   /* reserved */
    }bit;
}_v_svo_on_t;
...
typedef union tag_SVO_NUMBER
{
    ...
    struct
    {
        ...
        uint16_t                : 2;    /* reserved */
        uint16_t sv_no_type     : 2;    /* sv_no_type [1:0] */
        uint16_t                : 6;    /* reserved */
    }bit;
}_v_svo_number_t;
...
typedef union tag_DAC_NF_CONTROL
{
    ...
    struct
    {
        ...
        uint16_t bbkn_en        : 1;    /* bbkn_en */
        uint16_t                : 2;    /* reserved */
        uint16_t bbkn_th        : 6;    /* bbkn_th [5:0] */
        uint16_t                : 2;    /* reserved */
...
typedef union tag_DAC_CONTROL
{
    ...
    struct
    {
        uint16_t dac1_auto      : 1;     /* dac1_auto '0' manual '1' auto */
        uint16_t dac2_auto      : 1;     /* dac2_auto '0' manual '1' auto */
        uint16_t dac3_auto      : 1;     /* dac3_auto '0' manual '1' auto */
        uint16_t dac_auto_type  : 1;     /* dac_auto_type '0' by FB '1' by Target control */
        uint16_t dac_sync_mode  : 1;     /* dac_sync_mode '0' cmd (sync_done) '1' ext (rising edge) */
        uint16_t dac1_fb_mode   : 1;     /* dac1_fb_mode '0' internal '1' ext multiple XC */
        uint16_t dac2_fb_mode   : 1;     /* dac2_fb_mode '0' internal '1' ext multiple XC */
        uint16_t dac3_fb_mode   : 1;     /* dac3_fb_mode '0' internal '1' ext multiple XC */
        uint16_t dac1_dec1_mode : 1;     /* dac1_dec1_mode '0' static '1' arithmetic exp */
        uint16_t dac2_dec1_mode : 1;     /* dac2_dec1_mode '0' static '1' arithmetic exp */
        uint16_t dac3_dec1_mode : 1;     /* dac3_dec1_mode '0' static '1' arithmetic exp */
        uint16_t                : 1;     /* reserved */
        uint16_t dac1_hold_en   : 1;     /* dac1_hold_en '0' disable '1' enable */
        uint16_t dac2_hold_en   : 1;     /* dac2_hold_en '0' disable '1' enable */
        uint16_t dac3_hold_en   : 1;     /* dac3_hold_en '0' disable '1' enable */
        uint16_t dac_fault_off  : 1;     /* dac_fault_off '0' disable '1' enable */
    }bit;
}_v_dac_control_t;
...
/* Name : GATE_CONTROL, access : r/w, default : 0x0000, address : 0xFA */
typedef union tag_GATE_CONTROL
{
    uint16_t ALL;
    struct
    {
        uint16_t gate1_L_en     : 1;     /* gate1_L_en */
        uint16_t gate2L__en     : 1;     /* gate2L__en */
        uint16_t gate3_L_en     : 1;     /* gate3_L_en */
        uint16_t                : 1;     /* reserved */
        uint16_t gate1_H_en     : 1;     /* gate1_H_en */
        uint16_t gate2_H_en     : 1;     /* gate2_H_en */
        uint16_t gate3_H_en     : 1;     /* gate3_H_en */
        uint16_t                : 9;     /* reserved */
    }bit;
}_v_gate_control_t;

/* Name : GATE1_OFFSET, access : r/w, default : 0x0000, address : 0xFB */
typedef union tag_GATE1_OFFSET
{
    uint16_t ALL;
    struct
    {
        uint16_t gate1_offset1  : 8;     /* gate1_offset1 [7:0] */
        uint16_t gate1_offset2  : 8;     /* gate1_offset2 [7:0] */
    }bit;
}_v_gate1_offset_t;

/* Name : GATE2_OFFSET, access : r/w, default : 0x0000, address : 0xFC */
typedef union tag_GATE2_OFFSET
{
    uint16_t ALL;
    struct
    {
        uint16_t gate2_offset1  : 8;     /* gate2_offset1 [7:0] */
        uint16_t gate2_offset2  : 8;     /* gate2_offset2 [7:0] */
    }bit;
}_v_gate2_offset_t;

/* Name : GATE3_OFFSET, access : r/w, default : 0x0000, address : 0xFD */
typedef union tag_GATE3_OFFSET
{
    uint16_t ALL;
    struct
    {
        uint16_t gate3_offset1  : 8;     /* gate3_offset1 [7:0] */
        uint16_t gate3_offset2  : 8;     /* gate3_offset2 [7:0] */
    }bit;
}_v_gate3_offset_t;

/* Name : SV_VAR_CONTROL1, access : r/w, default : 0x0000, address : 0xFE */
typedef union tag_SV_VAR_CONTROL1
{
    uint16_t ALL;
    struct
    {
        uint16_t sv_var_no      : 8;     /* sv_var_no [7:0] */
        uint16_t sv_var_size1   : 8;     /* sv_var_size1 [7:0] */
    }bit;
}_v_sv_var_control1_t;

/* Name : SV_VAR_CONTROL2, access : r/w, default : 0x0000, address : 0xFF */
typedef union tag_SV_VAR_CONTROL2
{
    uint16_t ALL;
    struct
    {
        uint16_t sv_var_size2   : 8;     /* sv_var_size2 [7:0] */
        uint16_t sv_var_size3   : 8;     /* sv_var_size3 [7:0] */
    }bit;
...
static const char* xcr_grp1_regs_str[XCR_GRP1_MAX] =
{
    ...
    "RECEIVE STATUS",
    "INTERRUPT STATUS",
    "CMD PARITY ERR STATUS1",
    "CMD PARITY ERR STATUS2",
    "SPI FAULT STATUS/CONTROL",
    "CLK CONTROL 1",
    "CLK CONTROL 2",
