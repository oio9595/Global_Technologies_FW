...
typedef union tag_CMD_PARITY_ERR_STATUS2
{
    ...
    struct
    {
        __I uint16_t ch17_par_err   : 1;    /* ch17_par_err */
        __I uint16_t ch18_par_err   : 1;    /* ch18_par_err */
        __I uint16_t ch19_par_err   : 1;    /* ch19_par_err */
        __I uint16_t ch20_par_err   : 1;    /* ch20_par_err */
        __I uint16_t ch21_par_err   : 1;    /* ch21_par_err */
        ...
        __I uint16_t ov50_det       : 1;    /* ov50_det */
    }bit;
...
typedef union tag_TEST_CONTROL
{
    ...
    struct
    {
        __IO uint16_t MCLK64_O      : 1;    /* MCLK64_O */
        __IO uint16_t MCLK_SEL      : 1;    /* MCLK_SEL */
        uint16_t                    : 2;    /* reserved */
        __IO uint16_t MCLK1_O       : 1;    /* MCLK1_O */
        uint16_t                    : 3;    /* reserved */
        __IO uint16_t DACO1_DIRECT  : 1;    /* DACO1_DIRECT */
        __IO uint16_t DACO2_DIRECT  : 1;    /* DACO2_DIRECT */
        __IO uint16_t DACO3_DIRECT  : 1;    /* DACO3_DIRECT */
        uint16_t                    : 3;    /* reserved */
        __IO uint16_t ADDR_EXT      : 1;    /* ADDR_EXT */
        __IO uint16_t TEST_EN       : 1;    /* TEST_EN */
    }bit;
}_v_test_control_t;
...
typedef union tag_OTP_WRITE
{
    ...
    struct
    {
        __IO uint16_t OTP_WSEL      : 4;    /* OTP_WSEL [3:0] */
        __IO uint16_t OTP_RD        : 2;    /* OTP_RD[1:0] */
        uint16_t                    : 9;    /* reserved */
        __IO uint16_t OTP_PG_DONE   : 1;    /* OTP_PG_DONE */
    }bit;
}_v_otp_write_t;
...
typedef union tag_SV_VAR_CONTROL1
{
    ...
    struct
    {
        __IO uint16_t sv_var_no      : 8;     /* sv_var_no [7:0] */
        __IO uint16_t sv_var_size1   : 8;     /* sv_var_size1 [7:0] */
    }bit;
