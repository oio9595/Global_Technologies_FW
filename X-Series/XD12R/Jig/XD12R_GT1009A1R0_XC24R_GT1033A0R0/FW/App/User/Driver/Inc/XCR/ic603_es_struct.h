...
#define XC_INTERNAL_MCLK   (50000000UL)    /* 50.0MHz */
...
typedef enum _xc_addr_grp1_
{
    ...
    XC_ERR_STATUS,/*0x18*/
    XC_CH_CRC_ERR_STATUS,/*0x19*/
    XC_CH_TIMEOUT_ERR_STATUS,/*0x1A*/
    XC_BIST_CONTROL_STATUS,/*0x1B*/
    XC_COMMUNICATION_FAULT_CONTROL,/*0x1C*/
    XC_CLK_CONTROL_1,/*0x1D*/
    XC_CLK_CONTROL_2,/*0x1E*/
    XC_SERIALIZER_CLOCK_GEN,/*0x1F*/
    XC_LATENCY,/*0x20*/
    XC_TIMEOUT,/*0x21*/
    XC_DAISIED_DEVICE_CH_SIZE,/*0x22*/
    XC_DAISY_SIZE_1,/*0x23*/
    XC_DAISY_SIZE_2,/*0x24*/
    XC_DAISY_SIZE_3,/*0x25*/
    XC_DAISY_SIZE_4,/*0x26*/
    XC_DAISY_SIZE_5,/*0x27*/
    XC_DAISY_SIZE_6,/*0x28*/
...
{
    XC_PORT1_LOCAL_RW_DATA1 = 0x70,/*0x70*/
...
typedef union tag_SVO_NUMBER
{
    ...
    struct
    {
        ...
        uint16_t                : 2;    /* reserved */
        uint16_t sv_no_multiplier : 2;    /* sv_no_multiplier [1:0] */
        uint16_t                : 6;    /* reserved */
    }bit;
}_v_svo_number_t;
...
typedef union _xc_otp_control_regs
{
