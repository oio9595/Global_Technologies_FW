...
#define XDIC_WRITE_BITS             ((SERIAL_CMD_SIZE + SERIAL_ADDR_SIZE + SERIAL_DATA_SIZE) * XDIC_DAISY_SIZE)
#define XDIC_READ_BITS              ((SERIAL_CMD_SIZE + SERIAL_ADDR_SIZE) * XDIC_DAISY_SIZE)
#define XDIC_READ_RECV_BITS         (SERIAL_CMD_SIZE + SERIAL_ID_SIZE + SERIAL_DATA_SIZE)
#define XDIC_LD_TRANS_BITS          ((SERIAL_CMD_SIZE + SERIAL_LD_SIZE * ((uint32_t)(XDIC_CH_SIZE / 2.0f))) * XDIC_DAISY_SIZE)
#define XDIC_FAULT_READ_BITS        (SERIAL_CMD_SIZE * XDIC_DAISY_SIZE)
#define XDIC_FAULT_RECV_BITS        (SERIAL_CMD_SIZE + SERIAL_FAULT_DATA_SIZE)
#define XDIC_SYNCGEN_BITS           (SERIAL_CMD_SIZE * XDIC_DAISY_SIZE)
#define XDIC_IDGEN_BITS             (SERIAL_CMD_SIZE * XDIC_DAISY_SIZE)
