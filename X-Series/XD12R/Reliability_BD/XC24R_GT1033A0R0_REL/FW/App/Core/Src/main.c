...
static void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_SetOutputPin(GPIOC, BUFFER_OE_Pin|XC_VCC_EN_Pin);

  /**/
  LL_GPIO_ResetOutputPin(DEBUG_GPIO_Port, DEBUG_Pin);

  /**/
  LL_GPIO_ResetOutputPin(XC_5V5_EN_GPIO_Port, XC_5V5_EN_Pin);

  /**/
  LL_GPIO_ResetOutputPin(XCR_NSS_GPIO_Port, XCR_NSS_Pin);
  ...
  /**/
  GPIO_InitStruct.Pin = BUFFER_OE_Pin|XC_VCC_EN_Pin|XC_5V5_EN_Pin;
  ...
  /**/
  GPIO_InitStruct.Pin = XCR_NSS_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(XCR_NSS_GPIO_Port, &GPIO_InitStruct);
