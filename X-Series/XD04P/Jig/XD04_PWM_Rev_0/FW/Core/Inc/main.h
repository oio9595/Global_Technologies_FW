...
#define XD_FB_IN_Pin LL_GPIO_PIN_5
#define XD_FB_IN_GPIO_Port GPIOC
...
#define MCP_SPI_MOSI_Pin LL_GPIO_PIN_2
#define MCP_SPI_MOSI_GPIO_Port GPIOB
...
#define XD_FB_OUT_Pin LL_GPIO_PIN_13
#define XD_FB_OUT_GPIO_Port GPIOB
...
#define MCP_SPI_CS_Pin LL_GPIO_PIN_6
#define MCP_SPI_CS_GPIO_Port GPIOC
...
#define MCP_SPI_CLK_Pin LL_GPIO_PIN_10
#define MCP_SPI_CLK_GPIO_Port GPIOC
#define MCP_SPI_MISO_Pin LL_GPIO_PIN_11
#define MCP_SPI_MISO_GPIO_Port GPIOC
#define DEBUG_Pin LL_GPIO_PIN_2
#define DEBUG_GPIO_Port GPIOD
#define PWM_IN_Pin LL_GPIO_PIN_3
...
#define XC_NSCS_HI()        XC_NSCS_GPIO_Port->BSRR = XC_NSCS_Pin <<  0U
#define XC_NSCS_LO()        XC_NSCS_GPIO_Port->BSRR = XC_NSCS_Pin << 16U

#define XD_FBI_HI()         XD_FB_IN_GPIO_Port->BSRR = XD_FB_IN_Pin <<  0U
#define XD_FBI_LO()         XD_FB_IN_GPIO_Port->BSRR = XD_FB_IN_Pin << 16U
...
#define XD_FBO_READ()       ((XD_FB_OUT_GPIO_Port->IDR) & (XD_FB_OUT_Pin))
