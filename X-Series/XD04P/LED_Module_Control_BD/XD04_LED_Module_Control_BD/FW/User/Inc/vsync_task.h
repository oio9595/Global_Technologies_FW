...
extern bool gb_led_enable_table[TOTAL_BLOCK_SIZE];

extern void Vsync_Timer_Start(void);
extern void Vsync_Timer_Stop(void);
extern void Vsync_Update_Handler(void);
extern void Vsync_Task(void);

extern void LED_Low_Current_Mode(uint8_t on_off);
extern void LED_Enable_Scan_No_Test(bool en);
extern void LED_Enable_Line_Delay_Test(bool en);
