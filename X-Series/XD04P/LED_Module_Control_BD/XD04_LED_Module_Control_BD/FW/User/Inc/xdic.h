...
extern void XDIC_Update_Max_Current_Vref(float in_current, bool low_current_mode);

extern uint8_t XDIC_Get_Daisy_Chain_Size(void);
extern void XDIC_Set_Daisy_Chain_Size(uint8_t daisy_chain_size);

extern bool* XDIC_Get_ID_Error_Channel_Table(void);
