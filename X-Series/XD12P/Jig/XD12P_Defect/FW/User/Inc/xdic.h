...
typedef union tag_XDIC_GENERAL_0x0B_0x16_T
{
    uint16_t val;
    struct
    {
...
typedef enum tag_XDIC_GENERAL_ADDR_T
{
    ...
    XDIC_ADDR_DELAY_CH_EXTEND_1     = 0X09, // 0x09
    XDIC_ADDR_DELAY_CH_EXTEND_2     = 0X0A, // 0x0A
    ...
    XDIC_ADDR_DELAY_CH_05           = 0X0F, // 0x0F
    XDIC_ADDR_DELAY_CH_06           = 0X10, // 0x10
    XDIC_ADDR_DELAY_CH_07           = 0X11, // 0x11
    XDIC_ADDR_DELAY_CH_08           = 0X12, // 0x12
    XDIC_ADDR_DELAY_CH_09           = 0X13, // 0x13
    XDIC_ADDR_DELAY_CH_10           = 0X14, // 0x14
    XDIC_ADDR_DELAY_CH_11           = 0X15, // 0x15
    XDIC_ADDR_DELAY_CH_12           = 0X16, // 0x16
