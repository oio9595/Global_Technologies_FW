...
extern bool gb_uart_tx_start;
extern osSemaphoreId_t JigTaskSemaphore;
...
extern void Uart_Rx_Parser(void);
extern void CQ24_Set_MCLK(bool en);
extern void CQ24_Set_Vsync(bool en);
/* USER CODE END EFP */

/* Private defines -----------------------------------------------------------*/
#define KEY_B1_Pin GPIO_PIN_13
#define KEY_B1_GPIO_Port GPIOC
...
#define	CQ24_NSCS_LO()          (NSCS1_GPIO_Port->BSRR = (uint32_t)NSCS1_Pin << 16U)
#define	CQ24_NSCS_HI()          (NSCS1_GPIO_Port->BSRR = NSCS1_Pin)

#define CQ24_VCC_OFF()          (CQ24_VCC_EN_GPIO_Port->BSRR = (uint32_t)CQ24_VCC_EN_Pin)
#define CQ24_VCC_ON()           (CQ24_VCC_EN_GPIO_Port->BSRR = (uint32_t)CQ24_VCC_EN_Pin << 16U)

#define CQ24_VCC_5V_OFF()	    (CQ24_5_0V_GPIO_Port->BSRR = (uint32_t)CQ24_5_0V_Pin << 16U)
#define CQ24_VCC_5V_ON()        (CQ24_5_0V_GPIO_Port->BSRR = (uint32_t)CQ24_5_0V_Pin)

#define CQ24_VCC_5V7_OFF()      (CQ24_5_7V_GPIO_Port->BSRR = (uint32_t)CQ24_5_7V_Pin << 16U)
#define CQ24_VCC_5V7_ON()       (CQ24_5_7V_GPIO_Port->BSRR = (uint32_t)CQ24_5_7V_Pin)
