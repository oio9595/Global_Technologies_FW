...
#define CQ24_CS_Pin LL_GPIO_PIN_3
#define CQ24_CS_GPIO_Port GPIOC
...
#define	CQ24_CS_LO()         (CQ24_CS_GPIO_Port->BSRR = (uint32_t)CQ24_CS_Pin << 16U)
#define	CQ24_CS_HI()         (CQ24_CS_GPIO_Port->BSRR = CQ24_CS_Pin)
