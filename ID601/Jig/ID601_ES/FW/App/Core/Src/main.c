...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* creation of ID601TestTask */
  ID601TestTaskHandle = osThreadNew(StartID601TestTask, NULL, &ID601TestTask_attributes);
...
static void MX_ADC1_Init(void)
{
  ...
  PB0   ------> ADC1_IN8
  */
  GPIO_InitStruct.Pin = ID601_TEST_Pin;
...
static void MX_SPI1_Init(void)
{
  ...
  PA7   ------> SPI1_MOSI
  */
  GPIO_InitStruct.Pin = IC603_CLK_Pin|ID603_MISO_Pin|IC603_MOSI_Pin;
...
static void MX_TIM1_Init(void)
{
  ...
  PA8   ------> TIM1_CH1
  */
  GPIO_InitStruct.Pin = ID601_SERIAL_OUT_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_1;
  LL_GPIO_Init(ID601_SERIAL_OUT_GPIO_Port, &GPIO_InitStruct);
...
static void MX_TIM2_Init(void)
{
  ...
  PB3   ------> TIM2_CH2
  */
  GPIO_InitStruct.Pin = ID601_SERIAL_IN_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_1;
  LL_GPIO_Init(ID601_SERIAL_IN_GPIO_Port, &GPIO_InitStruct);
...
static void MX_TIM3_Init(void)
{
  ...
  PC6   ------> TIM3_CH1
  */
  GPIO_InitStruct.Pin = ID601_SVSYNC_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_2;
  LL_GPIO_Init(ID601_SVSYNC_GPIO_Port, &GPIO_InitStruct);
...
static void MX_TIM4_Init(void)
{
  ...
  PB6   ------> TIM4_CH1
  */
  GPIO_InitStruct.Pin = IC603_FLLSYNC_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_2;
  LL_GPIO_Init(IC603_FLLSYNC_GPIO_Port, &GPIO_InitStruct);
...
static void MX_TIM5_Init(void)
{
  ...
  PA0-WKUP   ------> TIM5_CH1
  */
  GPIO_InitStruct.Pin = CNT_FREQ_IN_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_2;
  LL_GPIO_Init(CNT_FREQ_IN_GPIO_Port, &GPIO_InitStruct);
...
static void MX_TIM8_Init(void)
{
  ...
  /* TIM8 interrupt Init */
  NVIC_SetPriority(TIM8_BRK_TIM12_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),5, 0));
...
static void MX_GPIO_Init(void)
{
  ...
  /**/
  GPIO_InitStruct.Pin = IC603_MCLK_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_0;
  LL_GPIO_Init(IC603_MCLK_GPIO_Port, &GPIO_InitStruct);

  /**/
  GPIO_InitStruct.Pin = IC603_FB1_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(IC603_FB1_GPIO_Port, &GPIO_InitStruct);
...
/**
  * @brief  Function implementing the ID601TestTask thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_StartID601TestTask */
void StartID601TestTask(void *argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
