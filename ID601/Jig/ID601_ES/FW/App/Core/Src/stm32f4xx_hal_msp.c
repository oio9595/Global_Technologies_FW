...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    */
    ...
    HAL_GPIO_Init(ID601_TEST_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PB0     ------> ADC1_IN8
    */
    HAL_GPIO_DeInit(ID601_TEST_GPIO_Port, ID601_TEST_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, IC603_CLK_Pin|ID603_MISO_Pin|IC603_MOSI_Pin);
  ...
  else if(hspi->Instance==SPI2)
  {
    ...
    PB10     ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(GPIOC, ADC_MOSI_Pin|ADC_MISO_Pin);

    HAL_GPIO_DeInit(ADC_CLK_GPIO_Port, ADC_CLK_Pin);
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  else if(htim_base->Instance==TIM2)
  {
    ...
    */
    ...
    HAL_GPIO_Init(ID601_SERIAL_IN_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(htim_base->Instance==TIM5)
  {
    ...
    */
    ...
    HAL_GPIO_Init(CNT_FREQ_IN_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM1)
  {
    ...
    */
    ...
    HAL_GPIO_Init(ID601_SERIAL_OUT_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(htim->Instance==TIM3)
  {
    ...
    */
    ...
    HAL_GPIO_Init(ID601_SVSYNC_GPIO_Port, &GPIO_InitStruct);
  ...
  else if(htim->Instance==TIM4)
  {
    ...
    */
    ...
    HAL_GPIO_Init(IC603_FLLSYNC_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  else if(htim_base->Instance==TIM2)
  {
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(ID601_SERIAL_IN_GPIO_Port, ID601_SERIAL_IN_Pin);
  ...
  else if(htim_base->Instance==TIM5)
  {
    ...
    PA0-WKUP     ------> TIM5_CH1
    */
    HAL_GPIO_DeInit(CNT_FREQ_IN_GPIO_Port, CNT_FREQ_IN_Pin);
