...
static void comm_help_command(void)
{
    ...
    print(LOG_LV_INFO, "\r\n    ====       sal_ws [dec] [hex] [hex]   ====   dev_id, cmd, value    ====");
...
/*============================================================================================================*/
        ...
        else if(sscanf(str_in, "sal_boot_test %u", &u32_param[0]) == 1)
        {
            sal_mode_boot_test(u32_param[0]);
            print(LOG_LV_INFO, gp_msg_okay);
            print(LOG_LV_INFO, gp_msg_prompt);
        }
        else if(sscanf(str_in, "sal_tmux_sel %u", &u32_param[0]) == 1)
        {
