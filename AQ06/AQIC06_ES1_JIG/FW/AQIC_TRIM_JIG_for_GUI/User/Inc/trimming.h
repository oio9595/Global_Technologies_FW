...
EXTERN uint8_t read_reg_I2C(uint16_t in_addr);
...
EXTERN void I2C_init_test();
EXTERN void GUI_trim_VoltageTbl(float in_trim_volt[]);
EXTERN void GUI_trim_RangeTbl(uint16_t in_trim_rang[]);
...
// #define NO_SCREEN_AFTER_TRIMMING
