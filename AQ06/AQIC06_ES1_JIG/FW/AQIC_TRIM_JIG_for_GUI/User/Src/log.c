...
static float gf_adc_step_voltage = ((float)ADC_REF_VOLTAGE/ADC_RESOLUTION);
...
void log_send_function_test_min_max(min_max_t t_manual_function_test_min_max[FUNCTION_TEST_REPEAT_CNT][AQ06_O_MAX])
{
    ...
    {
        snprintf(msg_buffer, sizeof msg_buffer, "= REPEAT #%2u O1[%5u/%5u], O2[%5u/%5u], O3[%5u/%5u], O4[%5u/%5u], O5[%5u/%5u], O6[%5u/%5u] =\r\n", cnt, t_manual_function_test_min_max[cnt][AQ06_O1].min, t_manual_function_test_min_max[cnt][AQ06_O1].max, t_manual_function_test_min_max[cnt][AQ06_O2].min, t_manual_function_test_min_max[cnt][AQ06_O2].max, t_manual_function_test_min_max[cnt][AQ06_O3].min, t_manual_function_test_min_max[cnt][AQ06_O3].max, t_manual_function_test_min_max[cnt][AQ06_O4].min, t_manual_function_test_min_max[cnt][AQ06_O4].max, t_manual_function_test_min_max[cnt][AQ06_O5].min, t_manual_function_test_min_max[cnt][AQ06_O5].max, t_manual_function_test_min_max[cnt][AQ06_O6].min, t_manual_function_test_min_max[cnt][AQ06_O6].max);
        print(msg_buffer);
        snprintf(msg_buffer, sizeof msg_buffer, "=               [%5u],       [%5u],       [%5u],       [%5u],       [%5u],      [%5u]      =\r\n", (t_manual_function_test_min_max[cnt][AQ06_O1].max - t_manual_function_test_min_max[cnt][AQ06_O1].min), (t_manual_function_test_min_max[cnt][AQ06_O2].max - t_manual_function_test_min_max[cnt][AQ06_O2].min), (t_manual_function_test_min_max[cnt][AQ06_O3].max - t_manual_function_test_min_max[cnt][AQ06_O3].min), (t_manual_function_test_min_max[cnt][AQ06_O4].max - t_manual_function_test_min_max[cnt][AQ06_O4].min), (t_manual_function_test_min_max[cnt][AQ06_O5].max - t_manual_function_test_min_max[cnt][AQ06_O5].min), (t_manual_function_test_min_max[cnt][AQ06_O6].max - t_manual_function_test_min_max[cnt][AQ06_O6].min));
        print(msg_buffer);
    }
}

double cnv_adc_to_current(test_mode_t t_test_mode, uint8_t n_id, uint16_t n_mode_adc_reault[TEST_MODE_MAX][AQ06_O_MAX])
{
	float ret = 0;
...
void log_send_auto_test_result(uint8_t n_msg_type, uint8_t n_test_mode_result[TEST_MODE_MAX], uint16_t n_mode_adc_reault[TEST_MODE_MAX][AQ06_O_MAX])
{
    ...
    else if(n_msg_type == MSG_DETAIL)
    {
        ...
        for(t_test_mode = TEST_MODE_MEASURE ; t_test_mode<TEST_MODE_RESULT ; ++t_test_mode)
        {
    ...
    {
        test_mode_t t_test_mode = TEST_MODE_MEASURE;
