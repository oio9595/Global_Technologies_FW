...
{
    Print(LOG_DEBUG, "Key Function 1 executed\r\n");
}

static void Key_Func_2(void)
{
    Print(LOG_DEBUG, "Key Function 2 executed\r\n");
}
...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
static void Jig_Main_Task(void)
{
}
...
static void MX_SPI1_Init(void)
{
  ...
  PA7   ------> SPI1_MOSI
  */
  GPIO_InitStruct.Pin = ADC_CLK_Pin|ADC_MISO_Pin|ADC_MOSI_Pin;
...
static void MX_TIM5_Init(void)
{
  ...
  PA0-WKUP   ------> TIM5_CH1
  */
  GPIO_InitStruct.Pin = IP805_FREQ_IN_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_2;
  LL_GPIO_Init(IP805_FREQ_IN_GPIO_Port, &GPIO_InitStruct);
...
static void MX_USART1_UART_Init(void)
{
  ...
  PA10   ------> USART1_RX
  */
  GPIO_InitStruct.Pin = IP805_UART_Tx_Pin|IP805_UART_Rx_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_VERY_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
...
static void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(GPIOC, IP805_SFM_0_Pin|IP805_SFM_1_Pin|IP805_SFM_2_Pin|IP805_SFM_4_Pin
                          |LS_D4_Pin|LS_D3_Pin|LS_D2_Pin|LS_D1_Pin
                          |LS_EN1_Pin|LS_EN0_Pin);

  /**/
  LL_GPIO_ResetOutputPin(GPIOB, LS_D7_Pin|LS_D6_Pin|LS_D5_Pin|IP805_ATB_2_Pin
                          |IP805_ATB_1_Pin|IP805_TM_SEL_1_Pin|IP805_TM_SEL_0_Pin|IP805_TM_Pin
                          |IP805_EN_Pin);

  /**/
  LL_GPIO_ResetOutputPin(GPIOA, LS_D0_Pin|LS_EN2_Pin);
  ...
  /**/
  GPIO_InitStruct.Pin = IP805_SFM_0_Pin|IP805_SFM_1_Pin|IP805_SFM_2_Pin|IP805_SFM_4_Pin
                          |LS_D4_Pin|LS_D3_Pin|LS_D2_Pin|LS_D1_Pin
                          |LS_EN1_Pin|LS_EN0_Pin;
  ...
  /**/
  GPIO_InitStruct.Pin = ADC_CS_Pin|LS_D0_Pin|LS_EN2_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  ...
  /**/
  GPIO_InitStruct.Pin = LS_D7_Pin|LS_D6_Pin|LS_D5_Pin|IP805_ATB_2_Pin
                          |IP805_ATB_1_Pin|IP805_TM_SEL_1_Pin|IP805_TM_SEL_0_Pin|IP805_TM_Pin
                          |IP805_EN_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
