...
static void MX_SPI1_Init(void)
{
  ...
  PA7   ------> SPI1_MOSI
  */
  GPIO_InitStruct.Pin = XC_SPI_SCLK_Pin|SPI_MISO_Pin|SPI_MOSI_Pin;
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /**/
  LL_GPIO_SetOutputPin(XC_NSCS_GPIO_Port, XC_NSCS_Pin);
  ...
  /**/
  GPIO_InitStruct.Pin = JIG_TYPE_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_UP;
  LL_GPIO_Init(JIG_TYPE_GPIO_Port, &GPIO_InitStruct);
  ...
  /**/
  GPIO_InitStruct.Pin = XC_NSCS_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(XC_NSCS_GPIO_Port, &GPIO_InitStruct);
